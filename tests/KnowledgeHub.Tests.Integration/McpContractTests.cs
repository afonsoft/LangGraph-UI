...
public class McpContractTests : IClassFixture<McpContractTests.Fixture>
{
    ...
    {
        ["search_knowledge"] = """{"type":"object","properties":{"query":{"type":"string","description":"Texto ou pergunta a buscar"},"topK":{"type":"integer","description":"Máx. de resultados (default 5, máx 50)"}},"required":["query"]}""",
        ["ask_knowledge"] = """{"type":"object","properties":{"question":{"type":"string","description":"Pergunta em linguagem natural"},"topK":{"type":"integer","description":"Máx. de passagens usadas como contexto (default 5, máx 50)"}},"required":["question"]}""",
